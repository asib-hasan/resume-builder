...
export default {
  ...
  setup() {
    ...
    const editFolder = (folder) => {
      ...
      window.bootstrap.Modal.getOrCreateInstance(document.getElementById('editFolderModal')).show()
    }
    ...
    const updateFolder = async () => {
      ...
      try {
        ...
        if (response.status === 200) {
          ...
          fetchFolders()
          window.bootstrap.Modal.getInstance(document.getElementById('editFolderModal')).hide()
        }
      } catch (error) {
                  ...
                  <template #item="{ element }">
                    <tr>
                      ...
                      <td>
                        ...
                        <a href="#" @click="editFolder(element)" class="text-primary">
                ...
                <div class="modal-content">
                  <form @submit.prevent="updateFolder">
                    <div class="modal-header">
                      <h5 class="modal-name" id="editFolderModalLabel">Edit Folder</h5>
                      <button
                        type="button"
                        class="btn-close"
